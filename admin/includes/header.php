            ...
            <div class="nav-section">
                ...
                <?php if (showMenuItem($permissionManager, 'dashboard')): ?>
                    <a href="dashboard.php" class="nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'active' : ''; ?>">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" style="margin-right: 8px;">
                ...
                <?php if (showMenuItem($permissionManager, 'donation')): ?>
                    <a href="donation.php" class="nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'donation.php' ? 'active' : ''; ?>">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="white" stroke-width="2" style="margin-right: 8px;">
